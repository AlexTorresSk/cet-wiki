Create an `icons.json` file or whatever name you like and add the following structure.
...
```json
{
    ...
    "radio": {
        "unchecked": "<svg id='radio-unchecked' viewBox='0 0 5 5'><path d='M 2.5 0 C 1.121094 0 0 1.121094 0 2.5 C 0 3.878906 1.121094 5 2.5 5 C 3.878906 5 5 3.878906 5 2.5 C 5 1.121094 3.878906 0 2.5 0 Z M 2.5 4.5 C 1.394531 4.5 0.5 3.605469 0.5 2.5 C 0.5 1.394531 1.394531 0.5 2.5 0.5 C 3.605469 0.5 4.5 1.394531 4.5 2.5 C 4.5 3.605469 3.605469 4.5 2.5 4.5 Z M 2.5 4.5'/></svg>",
        "checked": "<svg id='radio-checked' viewBox='0 0 5 5'><path d='M 2.5 0 C 3.878906 0 5 1.121094 5 2.5 C 5 3.878906 3.878906 5 2.5 5 C 1.121094 5 0 3.878906 0 2.5 C 0 1.121094 1.121094 0 2.5 0 Z M 2.5 4.5 C 3.605469 4.5 4.5 3.605469 4.5 2.5 C 4.5 1.394531 3.605469 0.5 2.5 0.5 C 1.394531 0.5 0.5 1.394531 0.5 2.5 C 0.5 3.605469 1.394531 4.5 2.5 4.5 Z M 2.5 3.75 C 1.808594 3.75 1.25 3.191406 1.25 2.5 C 1.25 1.808594 1.808594 1.25 2.5 1.25 C 3.191406 1.25 3.75 1.808594 3.75 2.5 C 3.75 3.191406 3.191406 3.75 2.5 3.75 Z M 2.5 3.75'/></svg>"
    },
    "win": {
...
Then modify the icons you want displayed in the title bar.

> Please note that the icons must be svg and have the following structure.
...
After this in the creation of the title bar add

```js
const titlebar = new Titlebar({
    icons: 'path-icons-file' // Add this line
});
```